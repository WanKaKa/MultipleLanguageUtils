...
def get_user_path():
    return 'C:\\Users\\' + getpass.getuser() + '\\AppData\\Local\\Temp\\'
...
if __name__ == '__main__':
    ...
    button = tkinter.Button(win, text="修改", fg="white", bg="green", font=('Consolas', 16), command=start)
    button.place(x=360, y=380, width=240, height=40)
